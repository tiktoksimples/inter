...
function verificarValor() {
    if (valor >= 420 && valor < 430) {
        // Popup para valores entre 420 e 430
        showPopupL();
    } else if (valor >= 430 && valor < 440) {
        // Popup para valores entre 430 e 440
        showPopupL();
    } else if (valor >= 470 && valor < 475) {
        // Popup para valores entre 470 e 475
        showPopupL();
    } else if (valor >= 940 && valor < 950) {
        // Popup para valores entre 940 e 950
        showPopupL();
    } else if (valor >= 1000) {
        // Popup para valores a partir de 1400
        showPopupL();
    }
}
